    ...
    return (<Fragment>
        ...
        <div className="row mb-3">
            <div className="modal-body">
                <div className="form-group">
                    ...
                    <input className="form-control" id="inputNamaMasterBarang" type="text" placeholder="Masukkan nama barang" name="namaBarang" required={true} />
                </div>
        ...
        <div className="row mt-3 mb-3">
            ...
            <div className="form-group">
                    ...
                    <select name="" id="pilihSupplierMasterBarang" className='form-select'>
